...
* **eslint-plugin-react** does not support ESLint 10. The `version: 'detect'` setting triggers a call to the removed `context.getFilename()` API. Workaround: `reactVersion` is a required option instead of auto-detected. Track [jsx-eslint/eslint-plugin-react#3979](https://github.com/jsx-eslint/eslint-plugin-react/pull/3979).
